...
h2Title.forEach((h2, index) => {
    ...
    h2.addEventListener("click", () => {
        ...
        function changeBackground(index, image) {
            ...
            setTimeout(() => {
                container.style.backgroundImage = `url(./assets/src/images/${image}.jpg)`;
        ...
        switch(index) {
            case 0: 
                changeBackground(0, "mount")
                break;
            case 1:
                changeBackground(1, "rendang")
                break;
            case 2:
                changeBackground(2, "mosque")
                break;
            case 3:
                changeBackground(3, "reog")
                break;
            case 4:
                changeBackground(4, "komodo")
                break;
        }
